...
We can see that this is an odd-length Symmetric FIR filter and every even tap except for the middle tap has a value of 0, and the taps have symmetry about the center tap.  This allows the filter to be implemented in an efficient manner:
